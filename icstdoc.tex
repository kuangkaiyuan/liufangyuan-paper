...
Dex bytecode and does not require access to high-level program source. Our approach exploits the two key structures of the Android Dex format
 to protect applications against both static and dynamic code analysis. 
 To deter static analysis, our approach leverages the fact all except floating
